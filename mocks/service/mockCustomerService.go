...
// Source: ./service/customerService.go
...
func (m *MockCustomerService) GetAllCustomer(arg0 string) ([]dto.CustomerResponse, *errs.AppErr) {
	m.ctrl.T.Helper()
...
func (m *MockCustomerService) GetCustomerByID(arg0 string) (*dto.CustomerResponse, *errs.AppErr) {
	m.ctrl.T.Helper()
